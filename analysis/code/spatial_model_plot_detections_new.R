...
path_png = 'analysis/results/spatial_model/map_detections_new.png'
path_gis_out = 'analysis/results/spatial_model/bat_pam_results.shp'

# Load data
load(path_combined_data)

# Summarise data
summary = dat[which(dat$n_bats > 0 & 
                dat$offshore & 
