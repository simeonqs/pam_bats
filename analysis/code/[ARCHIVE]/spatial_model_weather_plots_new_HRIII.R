...
path_png_temp = 'analysis/results/spatial_model/figure_temp_HRIII.png'
path_png_vind_ret = 'analysis/results/spatial_model/figure_vind_ret_HRIII.png'
path_png_vind_hast = 
  'analysis/results/spatial_model/figure_vind_hast_HRIII.png'
