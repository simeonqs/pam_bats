...
files_aspot_bats = files_aspot_bats[!str_detect(files_aspot_bats, 'HR3-4S')]
...
for(season in c('Forår 2023', 'Efterår 2023')){
  png(sprintf('%s/%s_HRIII.png', path_png, season),
      width = 12.5, height = 6, units = 'in', res = 1000) # open PNG
  # season = 'Forår 2023'
  par(mar = c(5, 7, 3, 1))
