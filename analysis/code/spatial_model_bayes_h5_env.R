...
# Description: Bayesian version of model for hypothesis 5. 
...
path_m = 'analysis/code/models/m_h5.stan'
path_pdf = 'analysis/results/spatial_model/model_h5_env.pdf'
...
## the effect of wind direction at peak of migration, 18 degrees, 3 m/s and 20 
## km off the coast 
...
plot(dat_model$wind_direction[sorter], 
