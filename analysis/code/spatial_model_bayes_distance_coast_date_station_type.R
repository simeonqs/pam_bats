...
path_m_dist_coast_date_station_type = 
  'analysis/code/models/m_dist_coast_date_station_type.stan'
path_pdf = 
  'analysis/results/spatial_model/model_dist_coast_date_station_type.pdf'
...
model = cmdstan_model(path_m_dist_coast_date_station_type)
