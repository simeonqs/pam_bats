...
path_m_date_temp_wind_dir = 'analysis/code/models/m_date_temp_wind_dir.stan'
path_pdf = 'analysis/results/spatial_model/model_date_temp_wind_dir.pdf'
...
model = cmdstan_model(path_m_date_temp_wind_dir)
